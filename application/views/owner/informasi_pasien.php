            ...
            <tbody>
              ...
              <?php foreach ($informasi->result() as $result) : ?>
                ...
                <tr>
                  ...
                  <td><?php echo $tgl ?></td>
                  <td>
                    <a href="<?php echo site_url('owner/detail_informasi_pasien/' . $result->id_pasien . '/' . $result->id_booking . '/' . $result->id_rekam_medis) ?>" class="btn btn-anim" style="height: 35px; width: 70px; background-color: #f40049; color: white; border-radius: 5px"><span> Lihat</span></a>
                  </td>
                </tr>
